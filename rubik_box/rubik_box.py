...
#    back = ['red', 'red', 'green', 'yellow']
    ...
    front = ['red', 'blue', 'orange', 'orange']
    top = ['yellow', 'white', 'yellow', 'red']
    left = ['blue', 'blue', 'white', 'green']
    right = ['white', 'blue', 'green', 'green']
    bottom = ['white', 'yellow', 'red', 'yellow']
    back = ['orange', 'orange', 'red', 'green']
